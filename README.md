...
Monu is a fork of Monero which changes its poof-of-work system to a neural proof-of-work which is described in detail [here](https://github.com/Monu-Fork/NPOW/blob/main/npow_whitepaper.pdf).
